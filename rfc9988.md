...
[^toascii-note]:
    Editor's note: Some other RFCs reference RFC 5890 as the source of ToASCII, since that is the document that replaces RFC 3490 and at least mentions ToASCII.
...
protocol defined by this specification at the time of publication and is based on a proposal described in
...
[](https://github.com/thomas-fossati/href){:brackets="angle"}.
A Rust implementation is available at [](https://codeberg.org/chrysn/cri-ref){:brackets="angle"};
it is being updated to revision -18 at the time of writing.
A python implementation is available as part of [](https://gitlab.com/chrysn/micrurus){:brackets="angle"}
...
the "Uniform Resource Identifier (URI) Schemes" registry {{IANA.uri-schemes}}, an unsigned
